...
- (void)awakeFromNib {
    [super awakeFromNib];
    // Initialization code
    self.desLabel.preferredMaxLayoutWidth = KScreenWidth - 90;
    self.nameLabel.preferredMaxLayoutWidth = KScreenWidth - 90;
    self.timeLabel.preferredMaxLayoutWidth = KScreenWidth - 90;
