...
@interface photoVC ()<UITableViewDelegate,UITableViewDataSource,DSImageBrowseCellDelegate,UIViewControllerPreviewingDelegate>
...
//                int random = 3;
            ...
            NSString *desc = [NSString stringWithFormat:@"这是什么时间上传的2018.04.13"];
...
- (void)present:(DSImageBrowseView *)imageView index:(NSInteger)index{
    ...
    scrollView.longPressBlock = ^(UIImageView *imageView) {
        ...
        id imageItem = [imageView.image imageDataRepresentation];
